...
namespace Hms.API.Controllers
{
    ...
    public class AuthController : ControllerBase
    {
        ...
        // [FromBody] is explicitly marked — do not rely on [ApiController] inference.
        // Only admin can reach this route (Authorize below).
        // The client never sends UserId — it is generated by the database.
        [HttpPost("users")]
        [Authorize(Roles = "admin")]
        ...
        // Body: "physician"  (plain JSON string — no wrapper DTO needed)
        ...
        // Body: true  or  false  (plain JSON bool — no wrapper DTO needed)
        ...
        // Delete → fully removed. Deactivate via UpdateStatus instead.
    }
}